...
function UserActivity() {
    ...
    // const getUserTransaction = async(e) => {
    ...
    //             setLastTenItems(recupLastTenItems)
    ...
    useEffect(() => {
        ...
        getUserTransaction()
    },[]) //[loggedUser.userAccountAddress, userTransactions], À comprendre ??

    return (
        <div>
            {/* <button className="mr-2 bg-red-600 p-1"  onClick={getUserTransaction}>TRANSACTIONS</button> */}
