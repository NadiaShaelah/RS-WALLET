...
import { passwordGlobale } from "../../src/Pages/Auth/SeedPhrase/SeedPhrase";

console.log("Sendeth :  ", passwordGlobale);
...
function SendEth() {
    ...
    async function toSendEth(e) {
        ...
        const bytes  = CryptoJS.AES.decrypt(descripPrivateKey, passwordGlobale[0]);//userPassword"souley"passwordGlobale[0]
