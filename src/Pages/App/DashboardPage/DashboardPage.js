...
import { passwordGlobale } from "../../Auth/SeedPhrase/SeedPhrase";
...
export default function DashboardPage() {
  ...
  //   return <h1>{getUserPassword} around here...</h1>
  ...
  return (
    <div className="accounts-infos p-4">
      <>
        ...
        {showTokenBalance && (
          <div className="another-tokens-balance">
            ...
            />
            <span className="text-xs">aaaaaaaaaaaa{ercTokensBalance}</span>
      ...
      <h3>{passwordGlobale} <span>Lorem ipsum dolor sit.</span> </h3>
    </div>
  );
